//question - Create a class Movie having instance variables id, name, 
//director, budget, release_date. Create a method name details(), 
//which will print the movie details in a single line. 
//Create parameterized constructors to take all input details and assign the values to the 
//given instance variable. Movie id will be autogenerated by the constructor. 
//The movie id should be the first two digits of movie name followed by the date of release. 
//Suppose movie name is "Sairat" and release date 30.02.2026 then ID will be -> SA30022026. 
//Create main class and from main() take n number of movie details as user input and do the below operations — 
//(i) void movieDetails(Movie[]) - print all movie details sorted by budget. 
//(ii) Movie maxBudget(Movie[]) - return movie class which has max budget. 
//(iii) void movieByYear(Movie[], Year) - where year is user input and pass as parameter and 
//print movie name match with year. (iv) void showA(Movie[], char x) - x is char pass as parameter 
//from user input, print movie name match with first char with 'X' and director name first char match with 'X'.
//input - 1 Sairat Nagraj 5000000 30.02.2026 2026 S
//output - ID: SA30022026, Name: Sairat, Director: Nagraj, Budget: 5000000.0, Release Date: 30.02.2026
